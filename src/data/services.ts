...
export const verticals: Vertical[] = [
  {
    ...
    subservices: [
      ...
      { slug: "sewer-line-repair-replacement", title: "Sewer Line Repair & Replacement", icon: "Sewer Line" },
      ...
      { slug: "showers-tubs", title: "Showers & Tubs", icon: "Water Line" },
      ...
      { slug: "city-sewer-hookup", title: "City Sewer Hookup", icon: "Sewer Line" },
      { slug: "wet-yards", title: "Wet Yard Solutions", icon: "Sewer Line" },
    ],
  },
  {
    slug: "heating",
